...
export default new Store({
  ...
  getters: {
    //curpage: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index']),
    //loading : (state:any, getters:any, global:any) => state.getIn(['$loading'])  ,
    //result : (state:any, getters:any, global:any) => state.getIn(['$result']) ,
    //topicTitle: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', "topicTitle"]),
    //topicTitle2: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', "topicTitle2"]),
    //liveList: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'liveList']),
    //topicList: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'topicList']),
    //topicPage: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', "topicPage"]),
    //liveTitle: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'liveTitle']),
    //liveTitle2: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'liveTitle2']),
   // banner: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'banner']),
   // ruleText: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'ruleText']),
   // backClass: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'backClass']),
  
   
    //sceneList: (state: any, getters: any, global: any) => global.getIn(['pageJson', 'pages/index/index', 'sceneList']),
  ...
  mutations: {
    /*
     ...
     SHOW_POP_INFO(state:any, payload:any) {
  ...
  actions: {
   ...
   async pageOnNextLoad({ state, dispatch, commit, getters ,global}: any) {
      ...
      //examine = true
      if(!bizScenario) bizScenario = 'default'
...
*/
    ...
    async updateTaskList({ state, dispatch, commit, getters }: any) {
     ...
     if(getOkTaskList.length==0) {
      ...
      taskList2 =  backClass2.filter((t:any)=>{   //过滤已完成          
